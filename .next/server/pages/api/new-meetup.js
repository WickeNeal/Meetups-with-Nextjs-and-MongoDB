...
async function handler(req, res) {
    if (req.method === "POST") {
        const data = req.body;
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://NealWicke:Wicke1234@cluster0.douoi.mongodb.net/?retryWrites=true&w=majority");
        const db = client.db();
